...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(({
  request
}) => request.mode === 'navigate', new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.NetworkFirst({
  cacheName: 'pages',
  plugins: [
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(({
  request
}) => request.destination === 'style' || request.destination === 'script' || request.destination === 'image', new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.NetworkFirst({
  cacheName: 'assets',
  plugins: [
